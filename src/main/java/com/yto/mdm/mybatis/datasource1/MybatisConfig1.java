package com.yto.mdm.mybatis.datasource1;
 ...
 */
@Configuration("configDataSource1")
public class MybatisConfig1 {

	public static final String MODEL_PACKAGE = "com.yto.mdm.mybatis.datasource1.entity";//Model所在包
	public static final String MAPPER_PACKAGE = "com.yto.mdm.mybatis.datasource1.mapper";//Mapper所在包
    ...
    public SqlSessionFactory sqlSessionFactoryBean(@Qualifier("dataSource1") DataSource dataSource) throws Exception {
        ...
        factory.setMapperLocations(resolver.getResources("classpath:mapper/datasource1/**/*.xml"));
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBeanName("dataSource1MapperScannerConfigurer");
        mapperScannerConfigurer.setSqlSessionFactoryBeanName("dataSource1SqlSessionFactory");
